...
def foo(path):
    ...
    classesFile = r"C:\Users\noore\OneDrive\Desktop\project\MiniPro\code\coco.names"
    classNames = open(classesFile).read().strip().split('\n')

    required_class_index = [2, 3, 5, 7]

    # Model Files
    modelConfiguration = r"C:\Users\noore\OneDrive\Desktop\project\MiniPro\code\yolov4.cfg"
    modelWeigheights = r"C:\Users\noore\OneDrive\Desktop\project\MiniPro\code\yolov4.weights"
